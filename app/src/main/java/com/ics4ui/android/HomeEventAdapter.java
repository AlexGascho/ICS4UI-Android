...
public class HomeEventAdapter extends FirebaseRecyclerAdapter<
        Event, HomeEventAdapter.HomeEventViewHolder> {
    public HomeEventAdapter(@NonNull FirebaseRecyclerOptions<Event> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull HomeEventAdapter.HomeEventViewHolder holder, int position, @NonNull Event model) {
